...
namespace Doc1
{
    ...
    [HelpFileBuilderPlugInExport("Doc1", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "Doc1 plug-in")]
    public sealed class Doc1PlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In Doc1PlugIn Execute() method");
        }
        #endregion
